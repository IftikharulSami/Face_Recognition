...
class FR_Services ():
    def __init__(self):
        self.train_faces = np.load(r'encodings/encoding1.npy')
        self.train_names = np.load(r'encodings/labels1.npy')
...
#         os.remove(r'encodings/encodings.npy')
#         os.remove(r'encodings/labels.npy')
#         train_faces = []
#         train_names = []
...
#                 train_faces.append(encodings)
#                 train_names.append(name)
#         np.save(r'encodings/encodings.npy', train_faces)
#         np.save(r'encodings/labels.npy', train_names)
#         train_names.clear()
#         train_names.clear()
        new_enc = []
...
#         resize_image = cv2.resize(frame, (360, 420), interpolation = cv2.INTER_AREA)
    ...
    def gen_face_enc (image, face_locations):
        ...
        # np.save(r'encodings/encodings.npy', face_encoding)
